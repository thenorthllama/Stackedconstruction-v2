...
export default function Footer() {
  return (
    <footer className="bg-warm-900 border-t border-warm-800">
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/profile.php?id=61586672805182"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Stacked Construction on Facebook"
                className="text-warm-600 transition-colors hover:text-white"
              >
              ...
              <a
                href="https://www.instagram.com/stackedconstruction/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Stacked Construction on Instagram"
                className="text-warm-600 transition-colors hover:text-white"
              >
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                href="https://www.linkedin.com/company/111945969/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Stacked Construction on LinkedIn"
                className="text-warm-600 transition-colors hover:text-white"
              >
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <address className="not-italic">
              <ul className="space-y-3 text-sm text-warm-500">
                ...
                <li>Fort Myers, FL 33901</li>
                <li className="pt-2 text-xs text-warm-600">
                  Mon–Fri: 7am–6pm
                  <br />
                  Sat: 8am–2pm
                </li>
